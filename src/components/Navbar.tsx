...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { 
      ...
      dropdown: [
        { name: 'Office Dresses', path: '/shop?subcategory=Office' },
        { name: 'Dinner Dresses', path: '/shop?subcategory=Dinner' },
        { name: 'Event Dresses', path: '/shop?subcategory=Event' },
        { name: 'Maxi Dresses', path: '/shop?subcategory=Maxi' },
        { name: 'Bodycon Dresses', path: '/shop?subcategory=Bodycon' },
        { name: 'Casual Dresses', path: '/shop?subcategory=Casual' },
        { name: 'Birthday Dresses', path: '/shop?subcategory=Birthday' },
    ...
    { 
      ...
      dropdown: [
        { name: 'Heels', path: '/shop?subcategory=Heels' },
        { name: 'Official Shoes', path: '/shop?subcategory=Official' },
        { name: 'Sneakers', path: '/shop?subcategory=Sneakers' },
        { name: 'Sandals', path: '/shop?subcategory=Sandals' },
        { name: 'Boots', path: '/shop?subcategory=Boots' },
        { name: 'Luxury Heels', path: '/shop?subcategory=Luxury' },
    ...
    { 
      ...
      dropdown: [
        { name: 'Handbags', path: '/shop?subcategory=Handbags' },
        { name: 'Office Bags', path: '/shop?subcategory=OfficeBags' },
        { name: 'Mini Bags', path: '/shop?subcategory=Mini' },
        { name: 'Luxury Bags', path: '/shop?subcategory=Luxury' },
        { name: 'Crossbody Bags', path: '/shop?subcategory=Crossbody' },
        { name: 'Party Bags', path: '/shop?subcategory=Party' },
        { name: 'Travel Bags', path: '/shop?subcategory=Travel' },
      ]
    },
    { 
      name: 'Collections', 
